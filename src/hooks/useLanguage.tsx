...
const translations = {
  ...
  recordingSavedCheck: "Înregistrare salvată! Verifică în Descărcări sau Galerie.",
  shareCancelled: "Partajare anulată. Înregistrarea a fost salvată în Descărcări.",
  saving: "Se salvează...",
